...
def amazon_login():
    ...
    email_account = input('please input your amazon account:')
    email_password = input('please input your password:')
    ...
    try:
        ...
        driver.find_element_by_id("dcq_question_subjective_1").send_keys(phone_number)
