import requests, re, time, pymongo, pymysql, csv, logging
...
def company_list():
    with open('/media/salesmind/Other/OTMS/e签宝股东.txt', 'r') as f:
...
def get_unique_key(url):
    ...
    try:
        company_name = selector.xpath(
            '//*[@id="searchlist"]/table[1]/tbody/tr[1]/td[2]/a/em/em/text()|//*[@id="searchlist"]/table[1]/tbody/tr[1]/td[2]/a/em/text()')[
            0]
